...
class ElevenLabsClient:
    ...
    def speech_to_speech(self, audio_path: str, voice_id: str, 
                        output_path: str, model_id: str = "eleven_english_sts_v2") -> str:
        ...
        for attempt in range(self.max_retries):
            try:
                ...
                if attempt < self.max_retries - 1:
                    ...
                    raise RuntimeError(f"Conversion failed after {self.max_retries} attempts: {e}")
