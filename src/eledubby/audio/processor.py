...
class AudioProcessor:
    ...
    def adjust_duration(self, audio_path: str, target_duration: float, 
                       output_path: str) -> str:
        ...
        logger.debug(f"Duration adjustment: current={current_duration:.3f}s, "
    ...
    def _pad_audio(self, audio_path: str, pad_duration: float, 
                   output_path: str) -> str:
        ...
        cmd = [
            "ffmpeg", "-f", "lavfi",
            "-i", f"anullsrc=r=16000:cl=mono:d={pad_duration}",
            "-acodec", "pcm_s16le",
            "-y", silence_path
        ]
    ...
    def _trim_audio(self, audio_path: str, target_duration: float, 
                    output_path: str) -> str:
